  ...
  return (
    <SectionWrapper id="about" className="flex flex-col gap-12">
      ...
      <div className="flex flex-col gap-3 text-left">
        <span className="text-xs font-mono uppercase tracking-widest text-accent-cyan">01 / CHAPTER</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
        ...
        >
          ...
          <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-accent-purple to-transparent" />
          ...
          <div className="flex flex-col gap-1 border-t border-white/5 pt-4 mt-auto">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-4xl font-display font-extrabold text-accent-cyan">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-accent-blue to-transparent" />
          ...
          <div className="flex flex-col gap-1 border-t border-white/5 pt-4 mt-auto">
            ...
            <div className="flex items-baseline gap-2">
              <span className="text-4xl font-display font-extrabold text-accent-blue">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
        >
          <div className="absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-accent-cyan to-transparent" />
